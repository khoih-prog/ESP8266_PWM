...
```
xy@xy-Inspiron-3593:~$ cd Arduino/xy/ESP8266_PWM_GitHub/
xy@xy-Inspiron-3593:~/Arduino/xy/ESP8266_PWM_GitHub$
```

2. Issue astyle command

```
xy@xy-Inspiron-3593:~/Arduino/xy/ESP8266_PWM_GitHub$ bash utils/restyle.sh
```
